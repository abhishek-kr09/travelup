  ...
  return (
    <div className="max-w-4xl mx-auto py-4 sm:py-8 space-y-6">
      <div className="surface-card p-6 sm:p-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-semibold mt-1">{user?.username}</h2>
        <p className="text-zinc-600 dark:text-zinc-400 mt-2">Manage your listings, bookings, and profile from one place.</p>

        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Link to="/listings/new" className="text-center bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 py-2.5 rounded-lg font-medium">Create Listing</Link>
